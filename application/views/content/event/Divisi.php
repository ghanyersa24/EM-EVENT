                            ...
                            <li class="step ">
                                ...
                                <div class="step-content">
                                    ...
                                    <div class="row" id="pnf">
                                            ...
                                            <div class="input-field col s1">
                                                              <button class="btn-floating  btn-small" type="button" id="addpnf"><i
                                                            class="material-icons right">add</i>button</button>
                                                             </div>
                                                             </div>
                                        <div class="step-actions">
                                ...
                                <div class="row" id="po">
                                        ...
                                        <div class="input-field col s1">
                                                              <button class="btn-floating  btn-small" type="button" id="addpo"><i
                                                             class="material-icons right">add</i>button</button>
                                                             </div>
                                    ...
                                    <div class="row" id="sd">
                                            ...
                                            <div class="input-field col s1">
                                                              <button class="btn-floating  btn-small" type="button" id="addsd"><i
                                                             class="material-icons right">add</i>button</button>
                                                            </div>
                                ...
                                <h5>Pengalaman Kepanitiaan</h5>
                                    ...
                                    <div class="row" id="pk">
                                        ...
                                        <div class="input-field col s1">
                                                              <button class="btn-floating  btn-small" type="button" id="addpk"><i
                                                             class="material-icons right">add</i>button</button>
                                                             </div>
                                    ...
                                    <div class="row" id="ad">
                                        ...
                                        <div class="input-field col s1">
                                                              <button class="btn-floating  btn-small" type="button" id="addad"><i
                                                             class="material-icons right">add</i>button</button>
                                                             </div>
                                ...
                                <h5>Prestasi</h5>
                                    ...
                                    <div class="row" id="p">
                                        ...
                                        <div class="input-field col s1">
                                                              <button class="btn-floating  btn-small" type="button" id="addp"><i
                                                             class="material-icons right">add</i>button</button>
                                                             </div>
                                    ...
                                    <div class="row" id="t">
                                        ...
                                        <div class="input-field col s1">
                                                              <button class="btn-floating  btn-small" type="button" id="addt"><i
                                                             class="material-icons right">add</i>button</button>
                                                             </div>
                                ...
                                <div class="step-content">
                                    ...
                                    <div class="row">
                                        <div class="col s6">
                                            <p>
                                                <label>
                                                    <input name='fasilitas[]' checked type="checkbox" id="Drone"
                                                        value='Drone' />
                                                    <span>Drone</span>
                                                </label>
                                            </p>
                                            <p>
                                                <label>
                                                    <input name='fasilitas[]' type="checkbox" id="Mobil"
                                                        value='Mobil' />
                                                    <span>Mobil</span>
                                                </label>
                                            </p>
                                            <p>
                                                <label>
                                                    <input name='fasilitas[]' type="checkbox" id="Laptop"
                                                        value='Laptop/Tab' />
                                        ...
                                        <div class="col s6">
                                            <p>
                                                <label>
                                                    <input name='fasilitas[]' type="checkbox" id="Kamera"
                                            ...
                                            <p>
                                                <label>
                                                    <input name='fasilitas[]' type="checkbox" id="Motor"
                                                        value='Motor' />
                                                    <span>Motor</span>
                                                </label>
                                            </p>
                                    ...
                                    <div class="row">
                                        <div class="col s6">
                                            <p>
                                                <label>
                                                    <input name='jaringan[]' type="checkbox" id="Transportasi"
                                                        value='Transportasi' />
                                            ...
                                            <p>
                                                <label>
                                                    <input name='jaringan[]' type="checkbox" id="Public"
                                                        value='Public Figure' />
                                            ...
                                            <p>
                                                <label>
                                                    <input name='jaringan[]' type="checkbox" id="Desain"
                                        ...
                                        <div class="col s6">
                                            ...
                                            <p>
                                                <label>
                                                    <input name='jaringan[]' type="checkbox" id="Pesta"
                                            ...
                                            <p>
                                                <label>
                                                    <input name='jaringan[]' type="checkbox" id="Katering"
                                    ...
                                    <div class="row">
                                        <div class="col s6">
                                            <p>
                                                <label>
                                                    <input name='keahlian[]' type="checkbox" id="Grafis"
                                                        value='Desain Grafis' />
                                            ...
                                            <p>
                                                <label>
                                                    <input name='keahlian[]' type="checkbox" id="Multimedia"
                                            ...
                                            <p>
                                                <label>
                                                    <input name='keahlian[]' type="checkbox" id="Ceremony"
                                        ...
                                        <div class="col s6">
                                            <p>
                                                <label>
                                                    <input name='keahlian[]' type="checkbox" id="Musik"
                                            ...
                                            <p>
                                                <label>
                                                    <input name='keahlian[]' type="checkbox" id="Menyetir"
                                ...
                                <div class="step-content"> -->
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <p>
                                                <label>
                                                    <input type="checkbox" class="filled-in" id="persetujuan    " required/>
                                                    <span>Saya menyatakan bahwa data yang saya isikan benar dan siap bertanggung jawab dengan data yang diisikan</span>
                                                </label>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col s12 right-align">
                                        ...
                                        <!-- <button class="btn waves-effect waves-light right-align" id="finish">Submit 
                                            <i class="material-icons right">send</i>
                                        </button> -->
                                        <a id="submit" class="right-align btn waves-effect">Submit Form</a>
...
$(document).ready(function() {
    $.ajax({
        ...
        success:(r)=>{
            if(r.error==false){
                ...
                Toast.fire({
                        type: 'error',
                        title: 'Maaf divisi tidak tersedia'
                    })
            }
    ...
    if ($("input,textarea").val()) {
      ...
      $("label").css({ transform: "translateY(-15px)", "font-size": "12px" });
    }
  }
